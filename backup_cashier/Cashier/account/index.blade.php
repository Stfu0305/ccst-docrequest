...
<div class="req-scroll">
    ...
    <div class="req-card">
        <div class="req-card-body">
            ...
            <div style="display:flex; align-items:center; gap:20px; margin-bottom:20px;">
                ...
                <div style="position:relative; flex-shrink:0;">
                    <div id="avatar-wrap"
                        ...
                        @if(auth()->user()->profile_photo)
                            <img id="avatar-img"
                                 src="{{ route('cashier.account.photo') }}"
                                 alt="Profile Photo"
                ...
                <form id="photo-form"
                      method="POST"
                      action="{{ route('cashier.account.updatePhoto') }}"
            ...
            <div class="form-row-2 mb-2">
                ...
                <div class="form-field">
                    <label>Role</label>
                    <div class="field-readonly">Cashier</div>
                </div>
            </div>
    ...
    <div class="req-card" style="margin-top:12px;">
        <div class="req-card-body">
            ...
            <form method="POST" action="{{ route('cashier.account.updateProfile') }}" id="profile-form">
                @csrf
                @method('PATCH')
    ...
    <div class="req-card" style="margin-top:12px;">
        <div class="req-card-body">
            ...
            <form method="POST" action="{{ route('cashier.account.updatePassword') }}" id="password-form">
                @csrf
                @method('PATCH')
